          ...
          <div className='row h-100'>
            ...
            {/* Main Image */}
              <div className='col-sm-12 col-md-12 col-lg-6'>
                <a href='https://chingu-voyages.github.io/v8-toucans-team-04/' target='_blank' rel="noopener noreferrer">
                  <img className='img-main mx-auto mb-3 w-75' src={atomistLandingImage} alt=''></img>
                </a>
              </div>
            {/* Description */}
